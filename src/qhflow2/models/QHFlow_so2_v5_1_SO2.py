...
class QHFlow_escn_v5_1_SO2(nn.Module):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(QHFlow_escn_v5_1_SO2, self).__init__()
    ...
    def _init_output_layers(self):
        ...
        # Create expansion and FC layers for each prediction target
    ...
    def _process_through_main_layers(
        ...
        fii = self.output_ii(fii_2)
        # fij = self.pre_output_ij(fij, fij_2)
        fij = self.output_ij(fij_2)
    ...
    def forward(self, data, H, keep_blocks=False):
        ...
        data["edge_index"] = radius_graph(data.pos, self.max_radius, data.batch)
        ...
        data["full_edge_index"] = radius_graph(data.pos, 10000, data.batch)
        ...
        final_result["full_edge_index"] = data["full_edge_index"]
        final_result["full_edge_distance_vec"] = data["full_edge_distance_vec"]
