...
from qhflow2.models.layers_v2 import get_time_embedding
...
class eSCNMDBackbone_ham(nn.Module, MOLEInterface):
    def __init__(
        ...
        #         activation_checkpoint_chunk_size=activation_checkpoint_chunk_size,
        #     )
        # self.xy_norm_1 = get_normalization_layer(
        #     self.norm_type,
        #     lmax=self.lmax,
        #     num_channels=self.sphere_channels,
        # )
        # self.xy_norm_2 = get_normalization_layer(
        #     self.norm_type,
        #     lmax=self.lmax,
        #     num_channels=self.sphere_channels,
        # )
        # self.xy_block = Edgewise(
        #     sphere_channels=self.sphere_channels,
        ...
        #     activation_checkpoint_chunk_size=activation_checkpoint_chunk_size,
        # )
        # self.x_norm = get_normalization_layer(
        #     self.norm_type,
        #     lmax=self.lmax,
        #     num_channels=self.sphere_channels,
        # )
    ...
    @staticmethod
    def to_e3nn_embeddings(embedding):
        lmax = embedding.shape[1]
        num_channels = embedding.shape[2]
        embedding = embedding.reshape(embedding.shape[0], -1)

        l = o3.Irreps(str(SphericalTensor(lmax, 1, -1)).replace('1x', f'{num_channels}x'))
        # multiple channels
        return l, embedding
    ...
    def forward(self, data_dict: AtomicData, ham_features: list[torch.Tensor]) -> dict[str, torch.Tensor]:
        ...
        data_dict["charge"] = torch.zeros(len(data_dict), dtype=torch.long).to(data_dict["pos"].device)
        ...
        # dst, src = graph_dict["edge_index"]
        # x_self_message = self.x_block(
        #     x_message,
        #     x_edge,
        #     graph_dict["edge_distance"],
        #     graph_dict["edge_index"],
        ...
        #     node_offset=graph_dict["node_offset"],
        # )
        # x_self_message = self.x_norm(x_self_message)
    
        # x_message = self.xy_norm_1(x_message)
        # _, xy_pair_message = self.xy_block(
        #     x_message,
        #     x_edge,
        #     graph_dict["edge_distance"],
        #     graph_dict["edge_index"],
        ...
        # xy_pair_message = self.xy_norm_2(xy_pair_message)
