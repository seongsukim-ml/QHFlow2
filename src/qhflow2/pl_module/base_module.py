...
# PySCF imports — lazy loaded for optional [dft] dependency
pyscf = None
dft = None
...
def _ensure_pyscf():
    ...
    if pyscf is None:
        try:
            ...
            raise ImportError(
                "pyscf is required for DFT inference. "
                "Install with: uv pip install 'qhflow2[dft]'"
            )
from qhflow2.common.metric import cal_orbital_and_energies, cal_orbital_and_energies_variable_size_grouped
from qhflow2.common.matrix_transforms import get_convention_dict, _build_final_matrix, _matrix_transform_list, _matrix_transform_single, _matrix_transform_single_optimized, _get_orbital_mask
