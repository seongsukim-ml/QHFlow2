...
# ================
# Physical constants (hardcoded to avoid ase dependency for core usage)
# Values from ase.units (CODATA 2014)
Bohr = 0.5291772105638411      # Angstrom
Hartree = 27.211396641308       # eV
Rydberg = Hartree / 2
kB = 8.617333262145e-5          # eV/K
fs = 1.0                        # femtosecond (ASE time unit)
kJ = 0.01036427230133138        # eV
mol = 6.02214076e23
kcal = kJ * 4.184
