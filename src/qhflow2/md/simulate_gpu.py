...
from qhflow2.md.ase_utils import Simulator, load_config
from qhflow2.md.rmd17_dataset import RMD17_DFT
...
def eval_and_init(config):
    ...
    if config["sim_type"] == "scflow":
        ...
        units = scflow_config.get("units", "ang")
...
"""
HDF5_USE_FILE_LOCKING=FALSE CUDA_VISIBLE_DEVICES=2 python -m  md.simulate_gpu --config_yml /root/25DFT/QHFlow/src/md/md_conf/ethanol.yml
HDF5_USE_FILE_LOCKING=FALSE CUDA_VISIBLE_DEVICES=1 python -m  md.simulate_gpu --config_yml /root/25DFT/QHFlow/src/md/md_conf/ethanol.yml --sim_type dft
HDF5_USE_FILE_LOCKING=FALSE CUDA_VISIBLE_DEVICES=0 python -m  md.simulate_gpu --config_yml /root/25DFT/QHFlow/src/md/md_conf/salicylic_acid.yml --sim_type dft
HDF5_USE_FILE_LOCKING=FALSE CUDA_VISIBLE_DEVICES=2 python -m  md.simulate_gpu --config_yml /root/25DFT/QHFlow/src/md/md_conf/salicylic_acid.yml
HDF5_USE_FILE_LOCKING=FALSE CUDA_VISIBLE_DEVICES=1 python -m  md.simulate_gpu --config_yml /root/25DFT/QHFlow/src/md/md_conf/naphthalene.yml
HDF5_USE_FILE_LOCKING=FALSE CUDA_VISIBLE_DEVICES=3 python -m  md.simulate_gpu --config_yml /root/25DFT/QHFlow/src/md/md_conf/aspirin.yml
"""
