...
# CUDA_VISIBLE_DEVICES=0 python -m  md.simulate_gpu --config_yml /root/25DFT/QHFlow/src/md/md_conf/ethanol.yml
# CUDA_VISIBLE_DEVICES=0 python -m  md.simulate_gpu --config_yml /root/25DFT/QHFlow/src/md/md_conf/salicylic_acid.yml --sim_type dft
# CUDA_VISIBLE_DEVICES=1 python -m  md.simulate_gpu --config_yml /root/25DFT/QHFlow/src/md/md_conf/salicylic_acid.yml
# CUDA_VISIBLE_DEVICES=1 python -m  md.simulate_gpu --config_yml /root/25DFT/QHFlow/src/md/md_conf/naphthalene.yml
# CUDA_VISIBLE_DEVICES=0 python -m  md.simulate_gpu --config_yml /root/25DFT/QHFlow/src/md/md_conf/aspirin.yml