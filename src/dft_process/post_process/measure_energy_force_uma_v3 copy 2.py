...
def process_single_file(args: Tuple) -> Dict:
    ...
    pred_processed_suffix = f"_processed_{_pred_xc}_tol{tol_str}_pad{pad_eigval_str}"
...
def main(
    ...
    pred_processed_suffix = f"_processed_{pred_xc}_tol{tol_str}_pad{pad_eigval_str}"
