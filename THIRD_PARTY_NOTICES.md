...
- Included license: `THIRD_PARTY_LICENSES/FairChem-MIT.txt`
...
- Included license: `THIRD_PARTY_LICENSES/e3nn-MIT.txt`
...
notice and does not replace the file-level licenses in `REUSE.toml`.
